...
class TensorBase(torch.nn.Module):
    ...
    @torch.no_grad()
    def filtering_rays(self, all_rays, all_rgbs, all_means=None, all_covs=None, N_samples=256, chunk=10240*5, bbox_only=False):
        ...
        if all_means is not None and all_covs is not None:
            return all_rays[mask_filtered], all_rgbs[mask_filtered], all_means[mask_filtered], all_covs[mask_filtered]
        return all_rays[mask_filtered], all_rgbs[mask_filtered], None, None
    ...
    def forward(self, rays_chunk, means, covs, white_bg=True, is_train=False, ndc_ray=False, N_samples=-1, train_iter=0):
        # sample points
